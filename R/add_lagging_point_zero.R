...
#' @examples
#'
#' #### (1) Example 1: prettier axis labels
...
#'
#' #### (2) Example 2: Bring all numbers up to the same number of decimal places
...
add_lagging_point_zero <-
  function(x, n){
    ...
    diff <- n - nchar(dp)
    if(any(diff < 0)){
      stop("n is too small; some numbers have more decimal places than n.")
    }
