...
#' \item{\link{add_lagging_point_zero}}{This function bring all numbers up the the same number of decimal places.}
#' }
#'
...
#'  \item{\link{pretty_ts}}{This function creaes pretty timeseries plots.}
...
#'  \item{\link{pretty_scape_3d}}{This function creates an interactive, 3-dimensional visualisations of landscapes/seascapes and/or environmental conditions.}
