...
#' @param pretty_axis_args A list of arguments passed to \code{\link[plot.pretty]{pretty_axis}} via the \code{axis_ls} argument to add an axis to the colour bar, defining the meaning of different colours.
