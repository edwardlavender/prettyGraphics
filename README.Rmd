...
* `add_shading()` adds blocks of shading to a plot to eludidate relationships between a response and explanatory variables, one of which is a factor;
...
* `plot_residuals()` creates prettier diagnostic residual plots (inlcuding standard diagnostic plots alongside residuals against covariates, timestamps and the autocorrelation function, if applicable); 
