...
You can install the released version of prettyGraphics from [CRAN](https://CRAN.R-project.org) with:
...
* `Tools4ETS::pretty_ts()`, which is based on `prettyGraphics`, creates pretty timeseries plots;
* `Tools4ETS::vis_ts()`, which is based on `prettyGraphics`, is an R Shiny-Dashboard user interface for the interactive exploration of (ecological) timeseries and creation of publication quality plots;
